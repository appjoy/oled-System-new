...
functions. We experimentally show that our new piece-wise OLED power model reduces the
...
\begin{itemize}[leftmargin=*]
  ...
  \item We propose a new piece-wise OLED power model and experimentally
