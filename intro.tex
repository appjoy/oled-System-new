...
5.1$\times$, 4.4$\times$ and 5.5$\times$ for dark
and 4.2$\times$, 2.5$\times$ and 2.3$\times$ for light mode for the three phones,
...
between 5\%-34\% (average 24\%), 13\%-36\% (average 26\%), and
13\%-24\% (average 20\%) at the 50\% brightness level,
%    , and
%    48\%-67\% (average 58\%), 
%    64\%-81\% (average 72\%),
...
-3\%-15\% (average 7\%),
-13\%-13\% (average 6\%),
and 0\%-16\% (average 11\%) at the 50\% brightness level
%  2\%-29\% (average 15\%),
%  16\%-46\% (average 32\%),
