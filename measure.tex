...
generations, Pixel 2 (2017), Moto Z3 (2018), and Pixel 4 (2019),
% released in 2017, 2018, and 2019, respectively, 
as listed in
...
as the power draw when the screen is off and the app is running using a wakelock.
...
in displaying a static image,
we measure the phone power
and subtract from it both the dark screen power and the CPU idle power.
The above process is accurate
as in all three steps, the CPU utilization remains steady at 2.5\%, 4.9\%,
and 1.7\% busy on Pixel 2, Moto Z3, and Pixel 4, respectively.
...
0.002 (14), 0.04 (59) and 0.01 (25) linear RGB (sRGB) values for the 3 phones.
%, respectively.
...
for the three phones, respectively.
Similar gaps are also observed for yellow, \eg of
...
be higher than that for (32, 16, 0). Instead,
...
\begin{table}[tbp]
	...
	\caption{Sample RGB value pairs for which the OLED display
		...
		\hline
		1 chl to & ( 176,   0,   0) &  91 & ( 176,   0,  32) &  74 \\
		2 chl    & (   0,  16,   0) &  56 & (   0,  16,  16) &  48 \\
		         & (   0,   0,  48) &  56 & (  32,   0,  48) &  43 \\
		\hline
		2 chl to & ( 112,  80,   0) &  82 & ( 112,  80,  16) &  68 \\
		3 chl    & ( 112,   0, 192) & 146 & ( 112,  32, 192) & 131 \\
		         & (   0,  48,  48) &  71 & (  48,  48,  48) &  53 \\
		\hline
		\multicolumn{5}{c }{Moto Z3} \\
		\hline
		1 chl to & ( 240,   0,   0) & 230 & ( 240,   0,  32) & 220 \\
		2 chl    & (   0, 192,   0) & 135 & (  16, 192,   0) & 133 \\
		         & (   0,   0, 240) & 288 & (  32,   0, 240) & 273 \\
		\hline
		2 chl to & ( 192, 224,   0) & 246 & ( 192, 224,  48) & 220 \\
		3 chl    & ( 255,   0, 255) & 429 & ( 255,  48, 255) & 409 \\
		         & (   0, 224, 160) & 242 & (  64, 224, 160) & 215 \\
		\hline
		\multicolumn{5}{c }{Pixel 4} \\
		\hline
		1 chl to & (  80,   0,   0) & 105 & (  80,   0,  16) &  97 \\
		2 chl    & (   0,  48,   0) &  94 & (   0,  48,  16) &  91 \\
		         & (   0,   0, 240) & 233 & (  32,   0, 240) & 230 \\
		\hline
		2 chl to & (  32,  16,   0) &  97 & (  32,  16,  16) &  89 \\
		3 chl    & ( 128,   0,  16) & 113 & ( 128,  16,  16) & 109 \\
		         & (   0, 192, 176) & 234 & (  16, 192, 176) & 229 \\
		\hline
	\end{tabular}
         }
...
% nFrom reading AOSP source code~\cite{sourcecode:brightness1,sourcecode:brightness2},
We searched the kernel exported hardware info (\eg\ {\small \tt /sys/class/backlight})
and found that for Android Pie and later versions, % (\eg Pixel 2 and Moto Z3),
...
% linearly to the system brightness level.
...
{For example, our measurements have shown (results omitted due to page limit)
  that on Pixel 2, displaying the same
  magenta-color image under Natural and Saturated Color Modes
draws 7.1\% less and 19.7\% more power than the default color mode.
}
